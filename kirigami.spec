...
Source0  : https://download.kde.org/stable/frameworks/6.5/kirigami-6.5.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.5/kirigami-6.5.0.tar.xz.sig
...
%setup -q -n kirigami-6.5.0
cd %{_builddir}/kirigami-6.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723219335
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKirigami.so.6.5.0
/usr/lib64/libKirigamiDelegates.so.6
/usr/lib64/libKirigamiDelegates.so.6.5.0
/usr/lib64/libKirigamiDialogs.so.6
/usr/lib64/libKirigamiDialogs.so.6.5.0
/usr/lib64/libKirigamiLayouts.so.6
/usr/lib64/libKirigamiLayouts.so.6.5.0
/usr/lib64/libKirigamiPlatform.so.6
/usr/lib64/libKirigamiPlatform.so.6.5.0
/usr/lib64/libKirigamiPrimitives.so.6
/usr/lib64/libKirigamiPrimitives.so.6.5.0
/usr/lib64/libKirigamiPrivate.so.6
/usr/lib64/libKirigamiPrivate.so.6.5.0
